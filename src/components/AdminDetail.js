...
export default function AdminDetail() {
    ...
    const formValidation = (e) => {
        if (
            idForm === "Enter your Quiz Title or Code or Id" &&
            questionForm === "Enter Your Question" &&
            option1Form === "Answer Option 1" &&
            option2Form === "Answer Option 2" &&
            option3Form === "Answer Option 3" &&
            option4Form === "Answer Option 4" &&
                ...
                <input style={{width:'300px'}}  type="text" className="form-control" id="exampleInputPassword1" placeholder={quizTitle} onChange={(e)=>setQuizTitle(e.target.value)}/>
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            className="form-control input-css"
                            id="exampleInputPassword1"
                            placeholder={option1Form}
                            onChange={(e) => setOption1Form(e.target.value)}
                        />
                    </div>
                    <div className="form-group">
                        ...
                        <input
                            ...
                            className="form-control input-css"
                            id="exampleInputPassword1"
                            placeholder={option2Form}
                            onChange={(e) => setOption2Form(e.target.value)}
                        />
                    </div>
                    <div className="form-group">
                        ...
                        <input
                            ...
                            className="form-control input-css"
                            id="exampleInputPassword1"
                            placeholder={option3Form}
                            onChange={(e) => setOption3Form(e.target.value)}
                        />
                    </div>
                    <div className="form-group">
                        ...
                        <input
                            ...
                            className="form-control input-css"
                            id="exampleInputPassword1"
                            placeholder={option4Form}
                            onChange={(e) => setOption4Form(e.target.value)}
                        />
                    </div>
                    <div className="form-group">
